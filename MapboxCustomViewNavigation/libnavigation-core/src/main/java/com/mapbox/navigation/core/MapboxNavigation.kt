...
class MapboxNavigation(
    ...
    /**
     * API used to retrieve the SSML announcement for com.mapbox.navigation.ui.voice instructions.
     *
     * @return SSML com.mapbox.navigation.ui.voice instruction announcement string
     */
    ...
    private fun obtainUserAgent(isFromNavigationUi: Boolean): String {
        ...
        return if (isFromNavigationUi) {
            "$MAPBOX_NAVIGATION_UI_USER_AGENT_BASE/${"9.0.6"}"
        } else {
            "$MAPBOX_NAVIGATION_USER_AGENT_BASE/${"9.0.6"}"
        }
    }
