 ...
 * {@link SpeechPlayer} should be used based on com.mapbox.navigation.ui.voice language compatibility.
 * <p>
...
public class SpeechPlayerProvider {
     ...
     * @param voiceInstructionLoader com.mapbox.navigation.ui.voice instruction loader
     */
    ...
    /**
     * Set false to not fallback to TTS for com.mapbox.navigation.ui.voice guidance when the connection is slow.
     * The default setting is enabled. The TTS is used in two cases:
     * 1. when request polly com.mapbox.navigation.ui.voice fails
