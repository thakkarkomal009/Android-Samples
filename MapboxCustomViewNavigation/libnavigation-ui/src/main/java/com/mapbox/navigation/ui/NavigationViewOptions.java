...
public abstract class NavigationViewOptions {
  ...
  public abstract static class Builder {
    ...
    /**
     * Set true to mute the com.mapbox.navigation.ui.voice guidance when the Navigation starts
     *
    ...
    /**
     * Set false to not fallback to TTS for com.mapbox.navigation.ui.voice guidance when the connection is slow. The default setting is true.
     *
