...
/**
 * Default player used to play com.mapbox.navigation.ui.voice instructions when a connection to Polly is unable to be established.
 * <p>
 * This instruction player uses {@link TextToSpeech} to play com.mapbox.navigation.ui.voice instructions.
 */
class AndroidSpeechPlayer implements SpeechPlayer {
  ...
  /**
   * Plays the given com.mapbox.navigation.ui.voice instruction using TTS
   *
   * @param voiceInstructions with com.mapbox.navigation.ui.voice instruction to be synthesized and played
   */
  @Override
