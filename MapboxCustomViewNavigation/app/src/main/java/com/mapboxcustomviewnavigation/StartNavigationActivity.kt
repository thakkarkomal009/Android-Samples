...
class StartNavigationActivity : AppCompatActivity(), OnNavigationReadyCallback,
    NavigationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mActivity = this@StartNavigationActivity
...
// Empty because not needed in this example
    ...
    private fun getDirectionsRoute(): DirectionsRoute {
        val directionsRouteAsJson = GenerateRouteActivity.getCurrentRoute()
        Log.d("Routes for navigation::", directionsRouteAsJson)
