...
class RouteUrl(
    ...
    companion object {
        ...
        /**
         * Change the units to imperial for com.mapbox.navigation.ui.voice and visual information. Note that this won't change
         * other results such as raw distance measurements which will always be returned in meters.
         */
        const val IMPERIAL = "imperial"

        /**
         * Change the units to metric for com.mapbox.navigation.ui.voice and visual information. Note that this won't change
         * other results such as raw distance measurements which will always be returned in meters.
         */
